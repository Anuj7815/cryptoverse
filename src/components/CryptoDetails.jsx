...
const CryptoDetails = () => {
  ...
  const stats = [
    ...
    {id:5, title: 'All-time-high(daily avg.)', value: `$ ${millify(cryptoDetails?.allTimeHigh.price)}`, icon: <TrophyOutlined /> },
  ];
  ...
  const genericStats = [
    ...
    {id:3, title: 'Approved Supply', value: cryptoDetails?.change ? <CheckOutlined /> : <StopOutlined />, icon: <ExclamationCircleOutlined /> },
